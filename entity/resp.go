...
func (this *parser) getSeqId() uint16 {
...
func (this *parser) getUint32() uint16 {
	ret := binary.LittleEndian.Uint32(this.Data[this.Current:this.Current + 4])
	this.Current += 4
	return ret
}

func (this *parser) getFloat32() uint16 {
	bits := binary.LittleEndian.(this.Data[this.Current:this.Current + 4])
...
func (this *parser) parseData2() int {
	...
	case 1:
		v = this.Data[this.Current]
	case 2:
		v = this.Data[this.Current+1] * 0x40 + this.Data[this.Current] - 0x80;
	case 3:
		v = (this.Data[this.Current+2] * 0x80 + this.Data[this.Current+1] - 0x80) * 0x40 + this.Data[this.Current] - 0x80;
	case 4:
		v = ((this.Data[this.Current+3] * 0x80 + this.Data[this.Current+2] - 0x80) * 0x80 + this.Data[this.Current+1] - 0x80) * 0x40 + this.Data[this.Current] - 0x80;
	case 5:
		// over flow, positive to negative
		v = (((this.Data[this.Current+4] * 0x80 + this.Data[this.Current+3] - 0x80) * 0x80 + this.Data[this.Current+2] - 0x80) * 0x80 + this.Data[this.Current+1] - 0x80)* 0x40 + this.Data[this.Current] - 0x80;
	case 6:
		// over flow, positive to negative
		v = ((((this.Data[this.Current+5] * 0x80 + this.Data[this.Current+4] -0x80) * 0x80 +  this.Data[this.Current+3] - 0x80) * 0x80 + this.Data[this.Current+2] - 0x80) * 0x80 + this.Data[this.Current+1] - 0x80) * 0x40 + this.Data[this.Current] - 0x80;
	default:
...
func (this *parser) uncompressIf() {
	if this.getLen() == this.getLen1() {
		this.Data = this.RawBuffer
	} else {
		b := bytes.NewReader(this.RawBuffer)
	...
	this.Current = this.getHeaderLen()
}
